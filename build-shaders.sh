...
glslangValidator $SRC/tinted-bfrag.glsl -V -o $OUT_UNOPTIMIZED/tinted-bfrag.spv -S frag
...
$SPIRV_OPT $OUT_UNOPTIMIZED/tinted-bfrag.spv -o $OUT_OPTIMIZED/tinted-bfrag.spv
